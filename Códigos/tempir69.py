...
class MLX90614():
    ...
    def __init__(self, address=0x69, bus_num=1):
...
print ('Temperatura do objeto de teste (69): ')
...
f = open ("/media/pi/DAQ1/teste69.txt",  'a') #abre o arquivo na froma de leitura e na froma "append" (significa que sempre salva no fim do arquivo referente sem sobreescreve-lo)
f.write (str(hoje))
f.write('\nInfravermelho 69')
...
while(1):
	...
	if __name__ == "__main__":
		...
		f = open ("/media/pi/DAQ1/teste69.txt",  'a')
		f.write('\n')
